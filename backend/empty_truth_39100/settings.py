"""
Django settings for empty_truth_39100 project.
...
ROOT_URLCONF = 'empty_truth_39100.urls'
...
WSGI_APPLICATION = 'empty_truth_39100.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_truth_39100 API",
    "DESCRIPTION": "API documentation for empty_truth_39100 App",
    "VERSION": "v1",
}
